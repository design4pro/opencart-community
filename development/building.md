...
> **Note:** Each package is named following the convention: `opencart-core-language-{lang}-{version}.ocmod.zip`
...
> **Warning:** Use language code in extension name: `language_pl`, `language_de`, etc. This prevents conflicts when multiple languages are installed.
...
> **Check:** Your language extension package is now ready to install via OpenCart's extension installer.
